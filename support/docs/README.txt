...
- "Bays [VTI]" (SBC_Category_ShipMod_Bay_Mfr_VTI [KYWD:xx000901])
...
- "Cargo [VTI]" (SBC_Category_ShipMod_Cargo_Mfr_VTI [KYWD:xx000902])
...
- "Cockpits [VTI]" (SBC_Category_ShipMod_Cockpit_Mfr_VTI [KYWD:xx000903])
...
- "Dockers [VTI]" (SBC_Category_ShipMod_Docker_Mfr_VTI [KYWD:xx000904])
...
- "Engines [VTI]" (SBC_Category_ShipMod_Engine_Mfr_VTI [KYWD:xx000905])
...
- "Equipment [VTI]" (SBC_Category_ShipMod_Equipment_Mfr_VTI [KYWD:xx000906])
...
- "Fuel Tanks [VTI]" (SBC_Category_ShipMod_FuelTank_Mfr_VTI [KYWD:xx000907])
...
- "Gear [VTI]" (SBC_Category_ShipMod_Gear_Mfr_VTI [KYWD:xx000908])
...
- "Grav Drives [VTI]" (SBC_Category_ShipMod_GravDrive_Mfr_VTI [KYWD:xx000909])
...
- "Mod [VTI]" (SBC_Category_ShipMod_Mod_VTI [KYWD:xx00090E])
...
- "Reactors [VTI]" (SBC_Category_ShipMod_Reactor_Mfr_VTI [KYWD:xx00090A])
...
- "Shields [VTI]" (SBC_Category_ShipMod_Shields_Mfr_VTI [KYWD:xx00090B])
...
- "Structural [VTI]" (SBC_Category_ShipMod_Structure_Mfr_VTI [KYWD:xx00090C])
...
- "Weapons [VTI]" (SBC_Category_ShipMod_Weapon_Mfr_VTI [KYWD:xx00090D])
