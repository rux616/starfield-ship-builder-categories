...
- "Cargo (DerreTech)" (Category_ShipMod_Cargo_DerreTech [KYWD:xx0008D2])
...
- "Engines (DerreTech)" (Category_ShipMod_Engine_DerreTech [KYWD:xx0008D0])
...
- "Gear (DerreTech)" (Category_ShipMod_Gear_DerreTech [KYWD:xx0008CD])
...
- "Grav Drives (DerreTech)" (Category_ShipMod_GravDrive_DerreTech [KYWD:xx0008CE])
...
- "Reactors (DerreTech)" (Category_ShipMod_Reactor_DerreTech [KYWD:xx0008CC])
...
- "Shields (DerreTech)" (Category_ShipMod_Shields_DerreTech [KYWD:xx0008D3])
