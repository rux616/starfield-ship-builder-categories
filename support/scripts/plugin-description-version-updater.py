...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Updates or adds the supplied version string to the description of an ESL, ESM, or ESP plugin for Oblivion, Skyrim, Fallout 3, Fallout: New Vegas, Fallout 4, and Starfield."
    )
    parser.add_argument(
        "version",
